...
def find_readout_time(x1,y1,dx,dy,overscan):
    ...
    #totalLineReadTime = (PIXEL_READ_TIME*(A+E) + PIXEL_IGNORE_TIME*B)*D + D*LINE_READ_TIME + LINE_IGNORE_TIME*C + LINE_IGNORE_TIME*(4136/2)*1
    #print(totalLineReadTime)
    totalLineReadTime = (((A+E)*3.5 + B*1 + 100)*D + C*100)/(1000*1000) + (100*(4136/2)*2)/(1000*1000)
    return totalLineReadTime

if __name__ == '__main__':
    print('Checking random number')
    print(find_readout_time(1696,1716,704,704,14))
