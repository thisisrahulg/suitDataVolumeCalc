...
// ; One cycle consists of 143 ROI sequences + 1 Full Frame sequence
// ; One cycle for ~ 3 hours, 8 such cycles 
...
// ;v9 - Changed Cycle and seq. for 94 Gb data volume
//
REPEAT_CAL:	SET_CYCLE	0009			// ;Set for 8 cycles in a day
//		
...
REPEAT_ROI:	SET_FRAME_SIZE	01			// ROI
		...
		SET_LED	2A43	022A	4427		// Correct / Update Shutter Offset value		
		HOME_SHU
		CCD_START						// start CCD sequencer
//
		CNC								// Check and Execute TC
