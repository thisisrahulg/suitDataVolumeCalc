...
// ;for 100Gb data throughput: 
// ; One cycle consists of 113 ROI sequences + 1 Full Frame sequence
// ; One cycle for ~ 2.4 hours, 10 such cycles 
// ;This program uses four observation IDs [96,97,98,99]
...
// ;v9 - Changed Cycle and seq. for 100 Gib data volume
//
REPEAT_CAL:	SET_CYCLE	0007			// ;Set for 13 cycles in a day
//		
		CLEAR_FLAG						// Clear all Flare Flags 	
		CLEAR_CCD	02					// Clears CCD to ensure no trapped charges
//
		SET_OBSERV_ID	BA				// ;Program Observation ID for the BIAS & DARK
...
//
		...
		CNC
//
BEGIN:	SET_OBSERV_ID	BB				// ;Program Observation ID for NORMAL Mode
...
//		
		...
		JNZS	MgCa_FILTERS			// Jump if seq. is not zero
//
//  ;FULL-FRAME SEQUENCE 
//		
		SET_FRAME_SIZE	00				// FULL-FRAME
