...
// ;for 87 Gb data throughput: 
// ; One cycle consists of 97 ROI sequences + One 2x2 Binned images sequence
// ; One cycle for ~ 2 hours, 12 such cycles 
// ;This program uses four observation IDs [B2,B3,B4,B5]
...
//
REPEAT_CAL:	SET_CYCLE	000C			// ;Set for 12 cycles in 24 hrs.
//		
		CLEAR_FLAG						// Clear all Flare Flags 	
		CLEAR_CCD	02					// Clears CCD to ensure no trapped charges
//
		SET_OBSERV_ID	B2				// ;Observation ID for the BIAS & DARK frames
...
//
		...
		CNC
//
BEGIN:	SET_OBSERV_ID	B3				// ;Observation ID for NORMAL Mode
...
//
NORM_FLARE:	SET_OBSERV_ID	B4			// ;Observation ID for Normal Flare
//
...
//							
PROM_FLARE:	SET_OBSERV_ID	B5			// ;Observation ID for Prom. Flare
		SET_FRAME_SIZE	01				// ROI
		ROI_UpdateEn
//
		SET_BIN	00						// No binning
