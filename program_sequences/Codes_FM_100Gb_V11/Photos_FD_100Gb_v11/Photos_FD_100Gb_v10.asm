// ; EEPROM Address - 
// ; Photos (Mg) FD images in three filter combinations 
// ;for 6 hours duration, flare routines as usual (default)
// ;will produce about 100 Gb data (before compression)
// ; This program uses four observation IDs [71,72,73 and F7]
...
//
		...
		CCD_START						// 01 min dark, 2x2 binned image
		CNC
BEGIN:	SET_OBSERV_ID	71				// Program Observation ID for NORMAL Mode
		SET_FRAME_SIZE	00				// FULL FRAME
...
//
NORM_FLARE:	SET_OBSERV_ID	72			// ;Observation ID for Normal Flare
//
...
//							
PROM_FLARE:	SET_OBSERV_ID	73			// ;Observation ID for Prom. Flare
		SET_FRAME_SIZE	01				// ROI
		ROI_UpdateEn
//
		SET_BIN	00						// No binning
