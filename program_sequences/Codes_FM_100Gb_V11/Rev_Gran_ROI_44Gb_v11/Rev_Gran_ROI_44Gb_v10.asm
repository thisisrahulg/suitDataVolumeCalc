...
//
		...
		CCD_START						// 01 min dark, 2x2 binned image
		CNC
BEGIN:	SET_OBSERV_ID	86				// Observation ID for NORMAL Mode
		SET_FRAME_SIZE	00				// FULL-FRAME
...
//
NORM_FLARE:	SET_OBSERV_ID	87			// ;Observation ID for Normal Flare
//
...
//							
PROM_FLARE:	SET_OBSERV_ID	88			// ;Observation ID for Prom. Flare
		SET_FRAME_SIZE	01				// ROI
		ROI_UpdateEn
//
		SET_BIN	00						// No binning
