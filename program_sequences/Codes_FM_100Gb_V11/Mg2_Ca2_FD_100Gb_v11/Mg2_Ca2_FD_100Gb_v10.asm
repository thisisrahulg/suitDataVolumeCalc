// ; EEPROM Address - 
// ;Mg2 and Ca2 filters Full disk images for ~6 hours duration
// ;Should produce about 100 Gb data (before compression)
// ;This program uses four observation IDs [6B,6C,6D and F7]
...
//
		...
		CCD_START						// 01 min dark, 2x2 binned image
		CNC
BEGIN:	SET_OBSERV_ID	6B				// Observation ID for NORMAL Mode
		SET_FRAME_SIZE	00				// Full Frame
...
//
MG_FILTERS:	SET_FRAME_SIZE	00			// Full Frame
		SET_BIN	00						// No Binning
...
//		
		CLEAR_FLAG						// Clear All Flare flags
		JMP	MG_FILTERS					// Jump to Normal Routine
//									 
//	; Start of the routine to observe normal flares								
//
NORM_FLARE:	SET_OBSERV_ID	6C
//
