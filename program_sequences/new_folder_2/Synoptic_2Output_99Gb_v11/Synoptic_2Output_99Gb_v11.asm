// ; EEPROM Address - 
// ; Synoptic Two output mode program sequence for 99 Gb data 
...
// ;This program uses four observation IDs [9E,9F,A0,A1]
// ;It has 31 cycles of 23 RoI + 1 FF sequences
...
// ;v9 - Adjusted Cycke and Seq for less than 100 Gib
//
REPEAT_CAL:	SET_CYCLE	001F			// ;Set for 31 cycles in a day
//		
...
//
		SET_OBSERV_ID	9E				// Program Sequence ID for the BIAS & DARK frames
...
//
		...
		CNC
//
BEGIN:	SET_OBSERV_ID	9F				// Program Sequence ID for NORMAL Mode observations
...
//
//	;NORMAL MODE = 14 ROI sequences +  1 FF set in 30 Minutes duration
...
//
NORMAL_MODE:	SET_SEQ	0017			// 23 ROI seqs., 
