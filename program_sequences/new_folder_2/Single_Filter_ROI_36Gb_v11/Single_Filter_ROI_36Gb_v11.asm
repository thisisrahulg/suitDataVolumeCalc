...
//
		SET_OBSERV_ID	C6				// ;Program Observation ID for the BIAS & DARK
...
//
		...
		CNC
//
BEGIN:	SET_OBSERV_ID	C7				// ;Program Observation ID for NORMAL Mode
...
//
REPEAT_ROI:	SET_FRAME_SIZE	01			// ROI FRAME
		SET_BIN	00						// No Binning
		MOVE_FW1	05					// say, NB8
		MOVE_FW2	03					// NB8
		SET_EXP_TIME	51D0			
...
//
NORM_FLARE:	SET_OBSERV_ID	C8			// ;Observation ID for Normal Flare
//
...
//							
PROM_FLARE:	SET_OBSERV_ID	C9			// ;Observation ID for Prom. Flare
		SET_FRAME_SIZE	01				// ROI
		ROI_UpdateEn
//
		SET_BIN	00						// No binning
