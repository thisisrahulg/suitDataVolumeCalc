...
// ;v11- Callibration loop is modified; And infinite loop has been removed; IDs are changed to [CA, CB, CC, CD]
//
REPEAT_CAL:	SET_CYCLE	000C				// Set for 12 cycles, 6 hours
		CLEAR_FLAG						// Clear all Flare Flags 	
//
		SET_OBSERV_ID	CA				// ;Program Observation ID for the BIAS & DARK
...
//
		...
		CCD_START						// 01 min dark, 2x2 binned image
		CNC
BEGIN:	SET_OBSERV_ID	CB				// Observation ID for NORMAL Mode
		SET_FRAME_SIZE	00				// FULL-FRAME
...
//
NORM_FLARE:	SET_OBSERV_ID	CC			// ;Observation ID for Normal Flare
//
...
//							
PROM_FLARE:	SET_OBSERV_ID	CD			// ;Observation ID for Prom. Flare
		SET_FRAME_SIZE	01				// ROI
		ROI_UpdateEn
//
		SET_BIN	00						// No binning
