// ; EEPROM Address - 
// ;Rev. Gran. ROI - Number of filter combination in ROI - 3
// ;Program runs for 6 hours, 50 ROI sequences + 1 ff sequence
// ;One cycle for ~30 mins., Total 12 such cycles
// ;This program uses four observation IDs [86,87,88 and F7]
...
// ;v9 - same as v8, 44 Gb data
//
REPEAT_CAL:	SET_CYCLE	000C				// Set for 12 cycles, 6 hours
//		
		CLEAR_FLAG						// Clear all Flare Flags 	
//
		SET_OBSERV_ID	CE				// ;Program Observation ID for the BIAS & DARK
...
//
		...
		CCD_START						// 01 min dark, 2x2 binned image
		CNC
BEGIN:	SET_OBSERV_ID	CF				// Observation ID for NORMAL Mode
		SET_FRAME_SIZE	00				// FULL-FRAME
...
//
//	;NORMAL MODE STARTS = 50 ROI seq. +  1 FF seq. in 30 Minutes duration
//	;ROI SEQUENCE, Check EXT FLARE Trigger after every frame 
//	;SELF FLARE Trigger check done at ~ 77s cadense 
//
NORMAL_MODE:	SET_SEQ	0032			// 50 ROI sequences
...
//1
		...
		SET_LED	2A43	022A	4427		// Update Shutter Offset value
		HOME_SHU						// Shutter homing
		SET_EXP_TIME	51B0			// LUT address, 1400 ms 
		CCD_START
		CNC								// Check and Execute TC
		JIF	JUMP_EXT					// check for EXT FLARE Trigger
//2
...
//4
		...
		SET_LED	2A43	022A	4427		// Update Shutter Offset value
		HOME_SHU
		SET_EXP_TIME	51C8			// LUT address, 683 ms
		CCD_START
		CNC								// Check and Execute TC
		JIF	JUMP_EXT					// check for EXT FLARE Trigger
//5
...
//6
		...
		SET_LED	2A43	022A	4427		// Update Shutter Offset value
		HOME_SHU						// Shutter homing
		SET_EXP_TIME	51D8			// LUT address, 458 ms  
		CCD_START						// start CCD sequencer
		CNC								// Check and Execute TC
		JIF	JUMP_EXT					// check for EXT FLARE Trigger
//7
...
//
		...
		SET_LED	2A43	022A	4427		// Update Shutter Offset value
		HOME_SHU						// Shutter homing
		SET_EXP_TIME	51E0			// LUT address, 608 ms 
		CCD_START						// start CCD sequencer
		CNC								// Check and Execute TC
		JIF	JUMP_EXT					// check for EXT FLARE Trigger
//8
		...
		SET_LED	2A43	022A	4427		// Update Shutter Offset value
		HOME_SHU						// Shutter homing
		SET_EXP_TIME	51E8			// LUT address, 1400 ms 
		CCD_START						// start CCD sequencer
		CNC	
		JIF	JUMP_EXT					// check for EXT FLARE Trigger
//9
...
//
		...
		SET_LED	2A43	022A	4427		// Update Shutter Offset value
		HOME_SHU						// Shutter homing
		SET_EXP_TIME	51F0			// LUT address, 975 ms 
		CCD_START						// start CCD sequencer
		CNC								// Check and Execute TC
...
//10									
		...
		SET_LED	2A43	022A	4427		// Update Shutter Offset value
		HOME_SHU						// Shutter homing
		SET_EXP_TIME	51F8			// LUT address, 165 ms 
		CCD_START						// start CCD sequencer
//11
...
//
NORM_FLARE:	SET_OBSERV_ID	D0			// ;Observation ID for Normal Flare
//
...
//							
PROM_FLARE:	SET_OBSERV_ID	D1			// ;Observation ID for Prom. Flare
		SET_FRAME_SIZE	01				// ROI
		ROI_UpdateEn
//
		SET_BIN	00						// No binning
