// ; EEPROM Address - 
// ; Synoptic one output mode program sequence for 60 Gb data
// ; Uses 16 cycles of 19 ROI + 1 FF sequence
// ; This program uses four observation IDs [AA,AB,AC,AD]
...
//
REPEAT_CAL:	SET_CYCLE	0010			// Set for 16 cycles in a day
//		
		CLEAR_FLAG						// Clear all Flare Flags 	
		CLEAR_CCD	02					// Clears CCD to ensure no trapped charges
//
		SET_OBSERV_ID	AA				// Program Observation ID for the BIAS & DARK
...
//
		...
		CNC
//
BEGIN:	SET_OBSERV_ID	AB				// Program Observation ID for NORMAL Mode
...
//
//	;NORMAL MODE = 28 ROI sequences +  1 FF set in 48 Minutes duration
...
//
NORMAL_MODE:	SET_SEQ	001C			// Set for 28 ROI sequences
