// ; EEPROM Address - 
// ;Mg2 and Ca2 filters ROI images for ~6 hours duration
// ;Should produce about 6 GB data (before compression)
// ;This program uses four observation IDs [77,78,79 and F7]
...
//
		SET_CYCLE	01B0				// Repeat 432 times, each loop ~ 50 sec.
//
...
//
		...
		CCD_START						// 01 min dark, 2x2 binned image
		CNC
BEGIN:	SET_OBSERV_ID	77				// Program Sequence ID for NORMAL Mode observations
		SET_FRAME_SIZE	00				// Full Frame
