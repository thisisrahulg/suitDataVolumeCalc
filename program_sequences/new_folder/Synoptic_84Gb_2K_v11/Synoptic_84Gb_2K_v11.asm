...
// ;for 84 Gb data throughput: 
// ; One cycle consists of 197 (0xBB) ROI sequences + One 2x2 Binned images sequence
// ; One cycle for ~ 4 hours, 6 such cycles 
// ;This program uses four observation IDs [B6,B7,B8,B9]
...
//
REPEAT_CAL:	SET_CYCLE	0006			// ;Set for 6 cycles in 24 hrs.
//		
		CLEAR_FLAG						// Clear all Flare Flags 	
		CLEAR_CCD	02					// Clears CCD to ensure no trapped charges
//
		SET_OBSERV_ID	B6				// ; Observation ID for BIAS / DARK
...
//
		...
		CNC
//
BEGIN:	SET_OBSERV_ID	B7				// ;Observation ID for NORMAL Mode
...
//2									
		...
		JIF	JUMP_EXT					// check for EXT FLARE Trigger
//3									
		MOVE_FW1	03					// NB5 is at position 03 on 
		SET_LED	2A43	022A	4427	// Update Shutter Offset value
		HOME_SHU						// Shutter homing
...
//
NORM_FLARE:	SET_OBSERV_ID	B8			// ; Observation ID for Normal Flare
//
...
//							
PROM_FLARE:	SET_OBSERV_ID	B9			// ; Observation ID for Prom. Flare
		SET_FRAME_SIZE	01				// ROI
		ROI_UpdateEn
//
		SET_BIN	00						// No binning
