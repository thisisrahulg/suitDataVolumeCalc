...
//
		SET_OBSERV_ID	BE				// ;Program Observation ID for the BIAS & DARK
...
//
		...
		CNC
//
BEGIN:	SET_OBSERV_ID	BF				// ;Program Observation ID for NORMAL Mode
...
//
		...
		JNZS	MG_FILTERS				// Jump if seq. is not zero
//
//  	;FULL-FRAME SEQUENCE 
//		
		SET_FRAME_SIZE	00				// FULL-FRAME
...
//
NORM_FLARE:	SET_OBSERV_ID	C0			// ;Observation ID for Normal Flare
//
...
//							
PROM_FLARE:	SET_OBSERV_ID	C1			// ;Observation ID for Prom. Flare
		SET_FRAME_SIZE	01				// ROI
		ROI_UpdateEn
//
		SET_BIN	00						// No binning
