...
//
		SET_OBSERV_ID	C2				// ;Program Observation ID for the BIAS & DARK
...
//
		...
		CNC
//
BEGIN:	SET_OBSERV_ID	C3				// ;Program Observation ID for NORMAL Mode
...
//
NORM_FLARE:	SET_OBSERV_ID	C4			// ;Observation ID for Normal Flare
//
...
//							
PROM_FLARE:	SET_OBSERV_ID	C5			// ;Observation ID for Prom. Flare
		SET_FRAME_SIZE	01				// ROI
		ROI_UpdateEn
//
		SET_BIN	00						// No binning
